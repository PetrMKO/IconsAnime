        ...
        <div>
            <svg width="113" height="148" viewBox="0 0 113 148" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path
                    ...
                    stroke="#1F1F22" stroke-width="0.9"/>
                <path
                    d="M23.9993 71.5C23.8326 70.8333 33.0003 57.5 50.9993 74C67.432 89.0641 90.4993 58.1667 96.4993 48"
            ...
            <svg width="113" height="148" viewBox="0 0 113 148" fill="none" xmlns="http://www.w3.org/2000/svg">
                <circle cx="48.2829" cy="118" r="24.55" transform="rotate(169.082 48.2829 118)" fill="#F0C64C"
                        stroke="#1F1F22" stroke-width="0.9"/>
                <circle cx="47.8862" cy="118.586" r="19.05" transform="rotate(169.082 47.8862 118.586)" fill="#F7E1A0"
                        stroke="#1F1F22" stroke-width="0.9"/>
                <path
                    d="M40.3082 108.336L44.7672 112.313M58.1443 124.245C55.9995 127.205 50.5384 132.332 45.8532 129.162C41.168 125.992 46.1497 119.26 49.2263 116.29M58.1443 124.245L49.2263 116.29M58.1443 124.245L59.3331 122.488M49.2263 116.29L44.7672 112.313M49.2263 116.29L50.6605 114.486M44.7672 112.313L45.8806 110.825M44.7672 112.313L40.1437 118.042"
                    stroke="#1F1F22" stroke-width="0.9"/>
                <rect x="19.45" y="38.45" width="84.1" height="51.1" rx="1.55" stroke="#1F1F22" stroke-width="0.9"
                      stroke-dasharray="3 3"/>
                <path
                ...
                <path
                    d="M12.0963 23.8743C11.3013 27.0533 11.5691 30.4051 12.8588 33.4175C14.1486 36.4299 16.3893 38.9371 19.2385 40.5558C22.0876 42.1745 25.3885 42.8157 28.6364 42.3813C31.8844 41.9469 34.9008 40.4609 37.2245 38.1504C39.5482 35.8399 41.0513 32.832 41.5042 29.5866C41.957 26.3412 41.3347 23.0367 39.7322 20.1784C38.1298 17.32 35.6354 15.0651 32.6304 13.7582C29.6254 12.4513 26.2751 12.1644 23.0917 12.9414L26.6481 27.5137L12.0963 23.8743Z"
                    fill="#F7E1A0" stroke="#1F1F22" stroke-width="1.8" mask="url(#path-8-inside-1_555_37489)"/>
                <mask id="path-9-inside-2_555_37489" fill="white">
                    <path
                        d="M16.4134 5.05507C13.5575 5.69478 10.9512 7.15592 8.91552 9.25849C6.87982 11.3611 5.50364 14.0132 4.95654 16.8882L19.6921 19.6924L16.4134 5.05507Z"/>
                </mask>
                <path
                    d="M16.4134 5.05507C13.5575 5.69478 10.9512 7.15592 8.91552 9.25849C6.87982 11.3611 5.50364 14.0132 4.95654 16.8882L19.6921 19.6924L16.4134 5.05507Z"
                    fill="#F0C64C" stroke="#1F1F22" stroke-width="1.8" mask="url(#path-9-inside-2_555_37489)"/>
                <path
                    d="M64 35.5L64.2385 35.1184L63.7356 34.8041L63.5683 35.373L64 35.5ZM80 45.5L79.7615 45.8816L80.185 46.1463L80.4043 45.6976L80 45.5ZM91 23L86.6895 25.9016L91.3576 28.1838L91 23ZM59.4317 52.627L64.4317 35.627L63.5683 35.373L58.5683 52.373L59.4317 52.627ZM63.7615 35.8816L79.7615 45.8816L80.2385 45.1184L64.2385 35.1184L63.7615 35.8816ZM80.4043 45.6976L89.6255 26.8361L88.8169 26.4408L79.5957 45.3024L80.4043 45.6976Z"
                    fill="#1F1F22"/>
            </svg>
